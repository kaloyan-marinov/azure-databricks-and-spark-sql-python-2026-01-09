# 162-overview-of-the-databricks-account-console.md
...
The Databricks Account Console is:

- the account-level admin UI,
  where you can manage global settings across all of your Databricks workspaces

- accessible at https://accounts.azuredatabricks.net
...
Under «Previews», you can ...

Under «Settings», you can
manage the various account settings.
